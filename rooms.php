...
$params = [];
if ($hotel_id){
  $sql = 'SELECT r.*, h.name as hotel_name, h.city, h.rating FROM rooms r JOIN hotels h ON r.hotel_id = h.id WHERE r.hotel_id = ?';
  $params[] = $hotel_id;
} else {
  $sql = 'SELECT r.*, h.name as hotel_name, h.city, h.rating FROM rooms r JOIN hotels h ON r.hotel_id = h.id WHERE 1=1';
...
<?php foreach($rooms as $r): ?>
  <div class="col-md-6 mb-3">
    <div class="card">
      <div class="row g-0">
        <div class="col-4"><img src="<?php echo htmlspecialchars($r['photo']); ?>" class="img-fluid thumb" alt=""></div>
        <div class="col-8">
          <div class="card-body">
